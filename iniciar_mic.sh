...
pactl load-module module-remap-source source_name=virtual-mic master=virtual-sink.monitor source_properties=device.description="🎤 Mi Micro Virtual"
...
echo "✅ Micrófono virtual listo: '🎤 Mi Micro Virtual'"
